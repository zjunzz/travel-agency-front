...
define(['knockout'],
        function (ko)
        {
            ...
            return {createCookie: createCookie, readCookie: readCookie, eraseCookie: eraseCookie, readSettings: readSettings, QueryString: QueryString, isLogged: isLogged};
